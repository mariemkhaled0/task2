...
function Sidebar() {
  ...
  return (
    <aside className=" w-[300px] hidden md:block text-[#AEB9E1] border-r border-[#0F172A] h-full shadow-[0_0_2px_rgba(0,0,0,0.5)]  bg-[#0a112a]">
      <div className="p-7">
        <div className="flex justify-between items-center w-full  ">
          ...
          <div className="flex justify-between w-[15px]">
            <img src={rightArrow} />
            <img src={leftArrow} />
          </div>
        </div>
              ...
              {menuItems.map((item, index) => (
                <div className="flex justify-between py-3" key={index}>
                  ...
                  >
                    <img
                      className={`${
                        activeButton === index ? "filter-active mr-2" : " mr-2"
                      }`}
                      src={item.img}
                    />
                    <span
                  ...
                  >
                    <path
                      ...
                      stroke={activeButton === index ? "#CB3CFF" : "#AEB9E1"}
                      strokeLinecap="round"
